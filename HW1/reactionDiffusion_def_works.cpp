...
void runForGS(float d_a, float d_b, float dt, float f, float k)
{
  ...
  string s = string("./outputs/GS_intermediary_b.MAT");
  ...
  field_tmp *= field_b;
  field_tmp *= field_b;
  s = string("./outputs/GS_step_uv2.MAT");
  field_tmp.writeMatlab(s, string("x"));
  ...
  s = string("./outputs/GS_chemical_step_a.MAT");
  field_step.writeMatlab(s, string("x"));
  ...
  s = string("./outputs/GS_chemical_step_b.MAT");
  field_step_b.writeMatlab(s, string("x"));
  ...
  s = string("./outputs/GS_laplacian_a.MAT");
  laplacian.writeMatlab(s, string("x"));
  field_step += d_a * laplacian;
  s = string("./outputs/GS_step_a.MAT");
  field_step.writeMatlab(s, string("x"));
  s = string("./outputs/GS_a_prefinal.MAT");
  field.writeMatlab(s, string("x"));
  //s = string("./outputs/GS_step_a_final.MAT");
  //(field_step * 0.1).writeMatlab(s, string("x"));
  field += dt * field_step;
  ...
  s = string("./outputs/GS_step_b.MAT");
  field_step_b.writeMatlab(s, string("x"));
  field_b += dt * field_step_b;

  s = string("./outputs/GS_a_final.MAT");
  field.writeMatlab(s, string("x"));
  s = string("./outputs/GS_b_final.MAT");
  field_b.writeMatlab(s, string("x"));
...
void runEverytime()
{
  ...
  if (counter < 3 && !fieldUnstable(field, "if field") && !fieldUnstable(field_b, "if field_b")) {
    ...
    s = string("./outputs/GS_a_after_") + to_string(counter) + string(".MAT");
    field.writeMatlab(s, string("x"));
    s = string("./outputs/GS_b_after_") + to_string(counter) + string(".MAT");
    field_b.writeMatlab(s, string("x"));
  }
