...
//////////////////////////////////////////////////////////////////////
// eigenvalues of 2x2 non-symmetric matrix
//////////////////////////////////////////////////////////////////////
int inline computeEigenvalues2x2(
		float dout[2],
		float a[2][2])
{
  TNT::Array2D<float> A = TNT::Array2D<float>(2, 2, &a[0][0]);
  TNT::Array1D<float> eig = TNT::Array1D<float>(2);
  TNT::Array1D<float> eigImag = TNT::Array1D<float>(2);
